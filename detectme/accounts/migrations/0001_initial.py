...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DetectMeProfile'
        db.create_table(u'accounts_detectmeprofile', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='detectme_profile', unique=True, to=orm['auth.User'])),
            ('favourite_snack', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ))
        db.send_create_signal(u'accounts', ['DetectMeProfile'])


    def backwards(self, orm):
        # Deleting model 'DetectMeProfile'
        db.delete_table(u'accounts_detectmeprofile')
