...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'detectors_abusereport', (
            ...
            ('abuse_type', self.gf('django.db.models.fields.CharField')(default='SP', max_length=2)),
        ))
        db.send_create_signal(u'detectors', ['AbuseReport'])


    def backwards(self, orm):
        # Deleting model 'AbuseReport'
        db.delete_table(u'detectors_abusereport')
