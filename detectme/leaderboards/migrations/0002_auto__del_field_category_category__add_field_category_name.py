...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'leaderboards_category', 'category')

        # Adding field 'Category.name'
        db.add_column(u'leaderboards_category', 'name',
                      self.gf('django.db.models.fields.CharField')(default='tbd.', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Category.category'
        db.add_column(u'leaderboards_category', 'category',
                      self.gf('django.db.models.fields.CharField')(default='tbd.', max_length=50),
                      keep_default=False)

        # Deleting field 'Category.name'
        db.delete_column(u'leaderboards_category', 'name')
