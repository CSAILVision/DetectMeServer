...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'detectors_detector', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('target_class', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.DetectMeProfile'])),
            ('is_public', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('average_image', self.gf('django.db.models.fields.files.ImageField')(default='average_image/default.jpg', max_length=100)),
            ...
            ('weights', self.gf('django.db.models.fields.TextField')()),
            ('sizes', self.gf('django.db.models.fields.TextField')()),
            ('support_vectors', self.gf('django.db.models.fields.TextField')()),
            ('is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('hash_value', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['detectors.Detector'], null=True, blank=True)),
        ))
        db.send_create_signal(u'detectors', ['Detector'])

        # Adding model 'AnnotatedImage'
        db.create_table(u'detectors_annotatedimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('uploaded_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('location_latitude', self.gf('django.db.models.fields.FloatField')()),
            ('location_longitude', self.gf('django.db.models.fields.FloatField')()),
            ('motion_quaternionX', self.gf('django.db.models.fields.FloatField')()),
            ('motion_quaternionY', self.gf('django.db.models.fields.FloatField')()),
            ('motion_quaternionZ', self.gf('django.db.models.fields.FloatField')()),
            ('motion_quaternionW', self.gf('django.db.models.fields.FloatField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.DetectMeProfile'])),
            ('detector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['detectors.Detector'])),
        ))
        db.send_create_signal(u'detectors', ['AnnotatedImage'])

        # Adding model 'Rating'
        db.create_table(u'detectors_rating', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'detectors', ['Rating'])


    def backwards(self, orm):
        # Deleting model 'Detector'
        db.delete_table(u'detectors_detector')

        # Deleting model 'AnnotatedImage'
        db.delete_table(u'detectors_annotatedimage')

        # Deleting model 'Rating'
        db.delete_table(u'detectors_rating')
    ...
    models = {
        ...
        u'detectors.detector': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.DetectMeProfile']"}),
            'average_image': ('django.db.models.fields.files.ImageField', [], {'default': "'average_image/default.jpg'", 'max_length': '100'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
