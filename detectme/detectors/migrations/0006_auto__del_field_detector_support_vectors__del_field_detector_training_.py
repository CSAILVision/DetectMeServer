...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Detector.support_vectors'
        db.delete_column(u'detectors_detector', 'support_vectors')
    ...
    def backwards(self, orm):
        # Adding field 'Detector.support_vectors'
        db.add_column(u'detectors_detector', 'support_vectors',
