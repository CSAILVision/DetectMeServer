...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'detectors_extrainfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('detector', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['detectors.Detector'], unique=True)),
            ('support_vectors', self.gf('django.db.models.fields.TextField')()),
            ('training_log', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'detectors', ['ExtraInfo'])


    def backwards(self, orm):
        # Deleting model 'ExtraInfo'
        db.delete_table(u'detectors_extrainfo')
