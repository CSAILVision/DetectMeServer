...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.start_date'
        db.add_column(u'leaderboards_category', 'start_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.finish_date'
        db.add_column(u'leaderboards_category', 'finish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.start_date'
        db.delete_column(u'leaderboards_category', 'start_date')

        # Deleting field 'Category.finish_date'
        db.delete_column(u'leaderboards_category', 'finish_date')
