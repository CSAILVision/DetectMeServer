...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'leaderboards_performance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('detector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['detectors.Detector'])),
            ('average_precision', self.gf('django.db.models.fields.FloatField')()),
            ('precision', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('recall', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('test_set', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'leaderboards', ['Performance'])

        # Adding model 'Category'
        db.create_table(u'leaderboards_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'leaderboards', ['Category'])


    def backwards(self, orm):
        # Deleting model 'Performance'
        db.delete_table(u'leaderboards_performance')

        # Deleting model 'Category'
        db.delete_table(u'leaderboards_category')
